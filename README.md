...
- - <img alt="arXiv" src="https://img.shields.io/badge/arXiv-2307.05222 -red?logo=arxiv" height="14" /> [EMU: GENERATIVE PRETRAINING IN MULTIMODALITY](https://arxiv.org/abs/2307.05222). [EMU]
- <img alt="arXiv" src="https://img.shields.io/badge/arXiv-2308.09936 -red?logo=arxiv" height="14" /> [Generative Multimodal Models are In-Context Learners](https://openaccess.thecvf.com/content/CVPR2024/html/Sun_Generative_Multimodal_Models_are_In-Context_Learners_CVPR_2024_paper.html). [Emu2]
